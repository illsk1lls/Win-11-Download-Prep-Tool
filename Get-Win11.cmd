...
POWERSHELL -nop -c "Invoke-WebRequest -Uri https://github.com/ip7z/7zip/releases/download/26.02/7zr.exe -o '7zr.exe'"; "Invoke-WebRequest -Uri https://github.com/ip7z/7zip/releases/download/26.02/7z2602-extra.7z -o '7zExtra.7z'"; "Invoke-WebRequest -Uri https://wimlib.net/downloads/wimlib-1.14.1-windows-x86_64-bin.zip -o 'wimlib.zip'"; "Invoke-WebRequest -Uri https://helgeklein.com/files/SetACL/current/SetACL%%203.1.2%%20`(executable%%20version`).zip -o 'SetACL.zip'"
